...
**Trigger:** A new flight needs to be added to the departure board (e.g., charter,
diverted arrival turned into departure, etc.)

**Flow:**
1. Operator navigates to the "Add Flight" tab.
2. Form fields: Flight Number, Airline, Origin, Destination, Gate (opt.),
   Aircraft Type (opt.), Scheduled Departure.
...
**Inferred** — comment in `EtdCalculationService.java` states: *"In a real airline
