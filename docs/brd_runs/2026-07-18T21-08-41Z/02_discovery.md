...
| UI framework | Bootstrap 5 | CDN-loaded | `index.html` Bootstrap 5 CDN link — **Confirmed** |
| UI icons | Bootstrap Icons | CDN-loaded | `index.html` Bootstrap Icons CDN link — **Confirmed** |
| Chart library | Chart.js | CDN-loaded | `index.html`, used in `statistics.js` — **Confirmed** |
| Front-end language | Vanilla JavaScript (ES2017+) | N/A | `js/*.js` files — **Confirmed** |
| Data persistence | In-memory (`ConcurrentHashMap`) | N/A | `FlightRepository.java` line 14 — **Confirmed** |
